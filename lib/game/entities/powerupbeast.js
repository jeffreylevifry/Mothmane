ig.module(
    ...
    .defines(function () {
        ...
        EntityPowerupbeast = ig.Entity.extend({
            size: {
                x: 20,
                y: 20
            },
            ...
            animSheet: new ig.AnimationSheet('media/powerupSuper.png', 20, 20),
            ...
            check: function (other) {
                ...
                if (other instanceof EntityPlayer) {
                    localStorage.setItem('powerup', 4);
                    this.kill();
                }
            }
        });
