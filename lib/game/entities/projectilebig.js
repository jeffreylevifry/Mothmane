ig.module(
    ...
    .defines(function () {
        ...
        EntityProjectilebig = ig.Entity.extend({
            ...
            gravityFactor: .7,
            animSheet: new ig.AnimationSheet('media/projectilebig.png', 30, 30),
        ...
        ig.EntityPool.enableFor(EntityProjectilebig);
